...
public class LocalDbContext : DbContext
{
    ...
    public async Task ApplyPosRoutingSchemaAsync()
    {
        var columns = new[]
        {
            ...
            ,"ALTER TABLE PosOutlets ADD COLUMN WarehouseId TEXT NULL"
            ...
            ,"ALTER TABLE StockItems ADD COLUMN WarehouseId TEXT NULL"
            ...
            ,"ALTER TABLE PosProductModifiers ADD COLUMN GroupName TEXT NULL"
            ,"ALTER TABLE PosProductModifiers ADD COLUMN GroupRequired INTEGER NOT NULL DEFAULT 0"
            ,"ALTER TABLE PosProductModifiers ADD COLUMN GroupMaxSelect INTEGER NULL"
