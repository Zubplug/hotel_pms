            ...
            Expanded(
              child: OutlinedButton(
                ...
                style: OutlinedButton.styleFrom(
                  ...
                  side: BorderSide(color: isExecuting ? const Color(0xFF1E3355).withValues(alpha: 0.5) : const Color(0xFF1E3355)),
            ...
            Expanded(
              ...
              child: FilledButton(
                ...
                style: FilledButton.styleFrom(
                  ...
                  disabledBackgroundColor: const Color(0xFFD4A853).withValues(alpha: 0.7),
                  disabledForegroundColor: const Color(0xFF070D1A).withValues(alpha: 0.7),
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                  elevation: 0,
                ),
                child: isExecuting
