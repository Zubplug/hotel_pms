  ...
  if (!id || id === 'undefined') {
    return (
      <div className="p-8 max-w-5xl mx-auto mt-12">
        ...
        <Button variant="outline" className="mt-6 rounded-xl h-12 px-6" onClick={() => goBack(router, '/frontdesk/reservations')}>
