    ...
    <div className="flex gap-2">
      {status === 'OPEN' && (
        <button 
          ...
          disabled={loading}
          className="px-3 py-1.5 text-xs font-medium text-zinc-300 bg-zinc-800 hover:bg-zinc-700 hover:text-white rounded-md transition-colors disabled:opacity-50"
        >
          Acknowledge
        </button>
      )}
