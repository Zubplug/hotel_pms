...
export default function OpeningStockPage() {
  ...
  return <div className="min-h-full bg-slate-50">
    <div className="relative overflow-hidden bg-gradient-to-r from-[#0b1120] via-[#16253a] to-[#0b1120] px-6 py-8 text-white sm:px-8"><div className="pointer-events-none absolute -right-20 -top-24 h-72 w-72 rounded-full bg-emerald-500/15 blur-3xl" />
      <div className="relative mx-auto max-w-[1100px]"><div className="flex items-center gap-3"><span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-emerald-500/15 text-emerald-300 ring-1 ring-emerald-300/20"><PackagePlus className="h-5 w-5" /></span><div><p className="text-xs font-bold uppercase tracking-[0.18em] text-emerald-300">Inventory foundation</p><h1 className="mt-1 text-2xl font-bold tracking-tight">Opening stock control</h1><p className="mt-1 text-sm text-slate-400">Post verified legacy inventory into the main warehouse with a clear opening-balance trail.</p></div></div><div className="mt-6 grid gap-3 sm:grid-cols-3"><div className="rounded-xl border border-white/10 bg-white/10 p-4"><p className="text-xs font-semibold uppercase tracking-wider text-slate-400">Workflow scope</p><p className="mt-2 font-bold text-white">Main warehouse</p><p className="mt-1 text-xs text-emerald-200">Does not post to outlets</p></div><div className="rounded-xl border border-white/10 bg-white/10 p-4"><p className="text-xs font-semibold uppercase tracking-wider text-slate-400">Audit event</p><p className="mt-2 font-bold text-white">OPENING_BALANCE</p><p className="mt-1 text-xs text-emerald-200">Every submission is traceable</p></div><div className="rounded-xl border border-white/10 bg-white/10 p-4"><p className="text-xs font-semibold uppercase tracking-wider text-slate-400">Loaded warehouses</p><p className="mt-2 font-bold text-white">{warehouses.length}</p><p className="mt-1 text-xs text-emerald-200">Available for controlled entry</p></div></div></div>
    </div>
