        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="mt-6 border-t border-slate-200 pt-6">
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-4 gap-3 items-end">
              ...
              <div className="flex gap-3 pb-2 text-xs text-slate-700">
                <label className="flex items-center gap-1.5"><input type="checkbox" checked={unitForm.isPurchaseUnit} onChange={(e) => setUnitForm({ ...unitForm, isPurchaseUnit: e.target.checked })} /> Purchase unit</label>
                <label className="flex items-center gap-1.5"><input type="checkbox" checked={unitForm.isIssueUnit} onChange={(e) => setUnitForm({ ...unitForm, isIssueUnit: e.target.checked })} /> Issue unit</label>
              </div>
