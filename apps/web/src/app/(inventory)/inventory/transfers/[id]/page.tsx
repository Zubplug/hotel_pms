  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8 space-y-6">
      ...
      <div className="bg-slate-800 border border-slate-700 rounded-xl p-5 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
        <div><span className="text-slate-400">From</span><p className="text-slate-900 font-medium mt-0.5">{transfer.fromWarehouse.name}</p></div>
        <div><span className="text-slate-400">To</span><p className="text-slate-900 font-medium mt-0.5">{transfer.toWarehouse.name}</p></div>
        <div><span className="text-slate-400">Created</span><p className="text-slate-900 font-medium mt-0.5">{new Date(transfer.createdAt).toLocaleDateString()}</p></div>
