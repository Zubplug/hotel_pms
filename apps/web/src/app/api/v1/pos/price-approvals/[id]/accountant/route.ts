...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  if (approval.type === 'POS_PRICE_CHANGE' && details.stage !== 'ACCOUNTANT_REVIEW') return errorResponse('CONFLICT', 'This price request is not awaiting Accountant approval', 409);
