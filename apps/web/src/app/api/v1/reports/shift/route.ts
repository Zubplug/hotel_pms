...
export async function GET(req: NextRequest) {
  try {
    ...
    const reportRoles = ['CEO', 'SUPER_ADMIN', 'MANAGER', 'ADMIN', 'ACCOUNTANT', 'GENERAL_CASHIER', 'NIGHT_AUDITOR', 'GENERAL_MANAGER', 'FNB_MANAGER', 'DIRECTOR', 'EXECUTIVE'];
    ...
    const canViewAllUsers = capabilities.includes('ACCESS_MANAGEMENT') || reportRoles.includes(String(userRole).toUpperCase());
    if (!canViewAllUsers) {
