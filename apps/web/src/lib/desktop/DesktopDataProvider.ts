...
export const DesktopDataProvider: LodgeCoreDataProvider = {
  ...
  hardware: {
    ...
    printLaundryDocuments: async (ticket: any) => invokeDesktop('hardware.printLaundryDocuments', { ticket })
  },
  dashboard: {
  ...
  cityLedger: {
    ...
    advance: async (data: any) => invokeDesktop('cityLedger.advance', data),
  },
  ...
  eventHalls: {
    list: async (propertyId: string) => invokeDesktop('eventHalls.list', { propertyId }),
  },
  ...
  approvals: {
    ...
    requestComplimentary: async (payload: any) => {
      return invokeDesktop('approvals.requestComplimentary', payload);
    },
  },
  laundry: {
