...
export function RefundDialog({ open, onOpenChange, folio, reservation, paymentId, initialCategory = 'MANUAL_ADJUSTMENT' }: { open: boolean, onOpenChange: (open: boolean) => void, folio: any, reservation: any, paymentId: string, initialCategory?: string }) {
