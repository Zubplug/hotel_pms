...
const statusColors: Record<string, string> = {
  ...
  OCCUPIED: 'bg-yellow-100 text-yellow-800 hover:bg-yellow-100/80 dark:bg-yellow-900/30 dark:text-yellow-400',
...
export function StatusBadge({ status, className, ...props }: StatusBadgeProps) {
  ...
  return (
    <div className={className} {...props}>
      <Badge 
        variant="outline" 
        className={cn('font-medium border-transparent', colorClass)} 
      >
