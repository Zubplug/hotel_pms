...
async function main() {
  ...
  const restaurant = await prisma.posOutlet.findFirst({ where: { propertyId: property.id, name: 'STANZELN GRAND RESORT - RESTAURANT & BAR' } });
  ...
  console.log(`Name: Ogechi Nweke`);
  console.log(`Email: ogechinweke@gmail.com`);
  console.log(`PIN: ${pin}`);
}
