...
const prisma = new PrismaClient({
  datasources: {
    db: { url: "postgresql://neondb_owner:npg_RJcVz67CsOTh@ep-square-frog-b4u924xh-pooler.c-6.us-east-2.aws.neon.tech/neondb?sslmode=require&channel_binding=require" }
  }
});
