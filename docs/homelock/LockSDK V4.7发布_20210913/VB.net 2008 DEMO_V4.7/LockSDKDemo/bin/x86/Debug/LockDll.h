...
注意:         
=============================================================================*/
int __stdcall LS_MakeParaSettingCard(char *cardSnr, SYS_PARA_SETTING sysPara, BYTE bMaskBits1, BYTE bMaskBits2, BYTE bMaskBits3, int iFlags);
