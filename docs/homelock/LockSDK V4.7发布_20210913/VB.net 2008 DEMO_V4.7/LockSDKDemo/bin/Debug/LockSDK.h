...
说明:   Room要输入 门锁号!!  其格式视门锁管理软件而定, 请查看门锁管理软件的"客房设置"界面. 如果门锁管理软件中没有门锁号, 
        则请输入房号. 
=============================================================================*/
int __stdcall TP_MakeGuestCardEx2(char *card_snr, char *room_no, char *checkin_time,char *checkout_time, int iflags, int waitMs);



/*=============================================================================
函数名：                        TP_ReadGuestCardEx2
;
功　能：读宾客卡信息
输  入：waitMs -- 等待放卡的时间(单位:毫秒)
输  出: card_snr        --  卡号:       字符串, 至少预分配20字节
...
返回值：错误类型
=============================================================================*/
int __stdcall TP_ReadGuestCardEx2(char *card_snr,char *room_no, char *checkin_time, char *checkout_time, int *iFlags, int waitMs);
